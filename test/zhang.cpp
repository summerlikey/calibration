...
int zhang_calibration(string &images_path,string &result_path,int inter_x_num,int inter_y_num,int square_width,int square_height){
	...
	if(!fin.is_open()){
		cout<<"can not open images.txt"<<endl;
		return 0;
	}
	...
	while (getline(fin, filename))
	{
		...
		{
			image_count--;
			cout<<"the images: "<<filename<<" not exit"<<endl;
			continue;
		}
...
int main()
{
	string left_path = "./images/0715/left_images0715.txt";
	string left_result = "./images/0715/left_resul0715t.txt";
	zhang_calibration(left_path,left_result,12,8,40,40);
